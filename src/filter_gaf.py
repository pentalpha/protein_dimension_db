...
if __name__ == '__main__':
    ...
    goa_parsed = databases_dir+'/goa_parsed.tsv.gz'
    ids_path = output_dir + "/databases/ids.txt"
    goa_parsed_expanded_mf = output_dir+'/goa_parsed_expanded.mf.tsv.gz'
    goa_parsed_expanded_bp = output_dir+'/goa_parsed_expanded.bp.tsv.gz'
    goa_parsed_expanded_cc = output_dir+'/goa_parsed_expanded.cc.tsv.gz'
